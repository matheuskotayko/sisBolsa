...
public class LaboratorioController {
    ...
    public ResponseEntity<EntityModel<LaboratorioResponse>> buscar(
        ...
        return ResponseEntity.ok(comLinks(comOcupacao(laboratorioService.buscarOuFalhar(id))));
    }
    ...
    public ResponseEntity<EntityModel<LaboratorioResponse>> atualizar(
            ...
            @Valid @RequestBody LaboratorioRequest body) {
        Usuario usuario = usuarioLogado.obrigatorio();
        Laboratorio lab = laboratorioService.buscarExigindoGerencia(id, usuario);

        laboratorioService.aplicar(lab, body);
        lab.setAtivo(true);
        laboratorioService.atualizar(lab);
        return ResponseEntity.ok(comLinks(comOcupacao(lab)));
    }
